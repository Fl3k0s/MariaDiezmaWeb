/**
 * María Diezma Atelier - Catálogo de Colecciones
 * Gestiona el filtrado por colecciones y la apertura de fichas en nueva ventana
 */
...
// Función programática de apertura en nueva ventana
function onDressCardClick(dressId) {
  window.open(`detalle.html?vestido=${dressId}`, '_blank');
}
